...
export ZDOTDIR="${XDG_CONFIG_HOME:-$HOME/.config}/zsh" # This can be done in /etc/zsh/zshenv
export ZSH="${XDG_CONFIG_HOME:-$HOME/.config}/zsh/ohmyzsh" # move to .zshrc if problems
export ZSH_CUSTOM="${XDG_CONFIG_HOME:-$HOME/.config}/zsh/ohmyzsh/custom"
